<template>
  <Row type="flex" justify="center" align="middle" class="login" @keydown.enter.native="submitLogin">
    ...
    <Row class="header">
      <img src="../assets/feiyu.png" width="220px" />
      <div class="description">飞鱼教研后台管理</div>
    </Row>
    ...
    <Row class="foot">
      ...
      <Row type="flex" justify="center" class="copyright">
        Copyright © 2018 - Present <a href="https://github.com/xiake0/feiyu-plus-front" target="_blank" style="margin:0 5px;">xiake</a> 版权所有
      </Row>
    </Row>
   </Col>
  </Row>
